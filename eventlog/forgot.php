...
<body>
    ...
    <div class="wrapper">
        <div class="form3"><br>
            <h1 id="hhhh"> CHANGE PASSWORD </h1><BR><BR>
            ...
            <div class="container">
                ...
                <label>Username</label><br>
                    ...
                    <input class="text" id="confirmpassword" type="password" name="confirmpassword">
                </form>
                <br><br>
                <center><button type="submit" class="btn3" method="post" name="changepassword">Change Password</button>
                <button type="button" class="btn3" name="register" onclick="window.location.href='../eventlog/index.php'">Cancel</button>
                </center>          
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){ 
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            $link = "<script>window.open('http://localhost/eventlog/authenticator.php')</script>"; 
                            echo $link; 
...
<?php
    ...
    if (isset($_POST['username'])){
        ...
        if($newpassword !== $confirmpassword){
            ...
            echo "<h4>Password Changed. Go to <a href='../eventlog/index.php'> Login <a></h4>";
