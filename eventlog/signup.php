          ...
          <form method="post">
            <div class="wrapper">
                <div class="form2"><BR>
                  ...
                  <h1><input type = "submit"  class="btn2" value = "Register" >
                  <input type = "button" class="btn2" value = "Cancel" onclick="window.location.href = '../eventlog/index.php';"></h1>
              </div>
            </div>  
...
<?php
  ...
  if (isset($_REQUEST['username'])){
    ...
    if($password !== $confirm){
      ...
      if($result){
        header("Location: ../eventlog/index.php");
      }else{
