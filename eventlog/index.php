...
<body>
    ...
    <div class="wrapper">
        <div class="form"><br>
            ...
            <div class="container">
                <form class="form group" action="/authenticator.php"><br><br>
                <label>Username</label><br>
                    <input class="text" id="username" type="text" name="username"><br>
                ...
                <center><button type="submit" class="btn" method="post" name="login">Login</button>
                    <button type="button" class="btn" name="register" onclick="window.location.href='../eventlog/signup.php'">Register</button>
                </center>
                <!--<button type="button"  class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" onclick="openWin()">Login</button>-->
                <h1><a href="../eventlog/forgot.php" class="forgot"> Forgot Password? </a></h1>               
...
<?php
    ...
    if (isset($_POST['username'])){
        ...
        if($rows==1){
            ...
            header("location: ../eventlog/authenticator.php");
